                            ...
                            <div className='authWrapper bg-[#0c0c0c]'>
                                <div>
                                    <div className='flex items-center justify-center gap-6 pt-2'>
                                        <p className='font-thin cursor-pointer relative after:content-[""] after:h-[1.6px] after:bg-darkBlue after:absolute after:bottom-[-3px] after:left-[50%] after:translate-x-[-50%] after:w-[0px] hover:after:w-[100%] after:duration-[.20s]' onClick={()=>setForm(true)}>Register</p>
                                        <p className='font-thin cursor-pointer relative after:content-[""] after:h-[1.6px] after:bg-darkBlue after:absolute after:bottom-[-3px] after:left-[50%] after:translate-x-[-50%] after:w-[0px] hover:after:w-[100%] after:duration-[.20s]' onClick={()=>setForm(false)}>Login</p>
                                    </div>
