...
const Authenticate = () => {
  ...
  return (
    <div className='authWrapper'>
        <div className='authContainer bg-[#0b0b0b] min-h-screen text-white pb-60'>
            ...
            <div className='parent-container'>
                ...
                <div className='mt-10'>
                    <div className='heroHeader text-center'>
                        <h1 className='text-[2.2em] font-Open font-bold'>Welcome <span className='text-darkViolet'>to</span> the most <span className='text-darkViolet'>modern</span> social media</h1>
                            <button className='mt-7 duration-200 hover:-translate-y-[5px] bg-transparent border-2 border-[#dfab0e] rounded-lg p-2 text-[#dfab0e] hover:shadow-[0px_0px_4px_#dfab0e]'>Explore Now</button>
                    </div>
                </div>
                ...
                <div className='presentationWrapper mt-20'>
                    ...
                    <h2 className='font-bold text-[1.2em]'>What <span className='text-darkViolet'>is</span> DMedia ?</h2>
                    </div>
                    <div>
                        <img src={planets} className="max-w-[100%] object-cover w-[100%]" alt="planets"/>
                    </div>
                </div>
